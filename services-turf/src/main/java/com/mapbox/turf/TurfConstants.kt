...
object TurfConstants {
     ...
     * @since 1.2.0
     */
    const val UNIT_NAUTICAL_MILES = "nauticalmiles"
     ...
     * @since 1.2.0
     */
    const val UNIT_RADIANS = "radians"
     ...
     * @since 1.2.0
     */
    const val UNIT_DEGREES = "degrees"
     ...
     * @since 1.2.0
     */
    const val UNIT_CENTIMETERS = "centimeters"
     ...
     * @since 3.0.0
     */
    const val UNIT_CENTIMETRES = "centimetres"
     ...
     * @since 3.0.0
     */
    const val UNIT_KILOMETRES = "kilometres"
     ...
     * @since 1.2.0
     */
    const val UNIT_DEFAULT = UNIT_KILOMETERS
